...
\begin{proof}
  ...
  \end{equation}
  Нека $\beta$ е най-дългата дума, за която е изпълнено \Property{eq:10}.
  ...
  съществува по-дълга от $\beta$ дума, за която е изпълнено \Property{eq:10}.
  ...
  \item
    ...
    \begin{align*}
      \abs{yuv} & \leq b^{\texttt{height}(\lowercut{P}{\beta})} & \comment\text{от \Corollary{tree:upper-bound}}\\
                & \leq b^{|V|+1} & \comment\text{от \Property{eq:11}}\\
                & = p
    \end{align*}
  \item
