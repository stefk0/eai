...
\begin{lemma}[за покачването (безконтекстни езици)]
  ...
  \marginpar{Ще казваме, че $p$ е константа на покачването. Тук отново да напомним, че $0 \in \Nat$ и $xy^0uv^0w = xuw$.}
...
\begin{cor}
  ...
  \end{description}  
  \marginpar{\writedown Докажете! Аналогично е на \Corollary{pumping-reg}}
