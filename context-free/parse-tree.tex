...
\item
  ...
  \mynote{На англ. \emph{parse tree}.}
...
\item
  \mynote{В \cite[стр. 123]{papadimitriou} дават рекурсивна дефиниция на синтактично дърво.}
...
% \begin{problem}
%   Докажете, че ако $T$ е дърво, то $\texttt{Pref}(T) = T$.
% \end{problem}
