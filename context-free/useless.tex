...
\begin{hint}
  ...
  \item
    $\texttt{Gen[n+1]} \df \{A\in V \mid A \to_G \alpha\ \&\ \alpha \in (\Sigma \cup \texttt{Gen[n]})^\star \}$.
  \item
...
\end{framed}
\begin{proof}
  Прилагаме алгоритъма от \Lemma{useless1} и намераме множеството от променливи $V'$.
