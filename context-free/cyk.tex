...
\begin{proof}
  ...
  \item[($\supseteq$)]
    ...
    Понеже $G$ е в нормална форма на Чомски, правилото е от вида $A \to_G BC$ и тогава, според \Proposition{grammar:divide-2}, съществува някое $k$, за което $i \leq k < i+s$, и
    \begin{align*}
