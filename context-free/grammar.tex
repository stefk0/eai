...
\begin{proposition}\label{pr:grammar:derive:general}
  ...
  \begin{prooftree}
    \AxiomC{$A \derive{\ell_1} \alpha B \gamma$}
    \AxiomC{$B \derive{\ell_2} \beta$}
    \BinaryInfC{$A \derive{\ell_1+\ell_2} \alpha\beta\gamma$}
  \end{prooftree}
\end{proposition}
\begin{proof}
  Имаме следния извод:
  \begin{prooftree}
    ...
    \BinaryInfC{$\alpha B \derive{\ell_2} \alpha\beta$}
    \AxiomC{}
    \RightLabel{\scriptsize{(0)}}
    \UnaryInfC{$\gamma \derive{0} \gamma$}
    \RightLabel{\scriptsize{(2)}}
    \BinaryInfC{$\alpha B \gamma \derive{\ell_2} \alpha \beta \gamma$}
    \RightLabel{\scriptsize{(1)}}
    \BinaryInfC{$A \derive{\ell_1+\ell_2} \alpha\beta\gamma$}
  \end{prooftree}
\end{proof}
...
\begin{remark}
  Понеже \Proposition{grammar:derive:general} се използва често, нека да го означим като правило (3). С други думи,
  \begin{prooftree}
    \AxiomC{$A \derive{\ell_1} \alpha B \gamma$}
    \AxiomC{$B \derive{\ell_2} \beta$}
...
\begin{proof}
  ...
  \item
    ...
    \begin{prooftree}
      ...
      \AxiomC{$X_i \yield{\ell_i} \gamma_i\text{ за }i=0,\dots,n$}
      \RightLabel{\scriptsize{($\ell = 1 + \max\{\ell_0,\dots,\ell_n\})$}}
      \BinaryInfC{$X \yield{\ell} \gamma_0\cdots\gamma_n$}
    \end{prooftree}
    ...
    \begin{prooftree}
      ...
      \AxiomC{$\vdots$}
      \RightLabel{\scriptsize{\IndHyp}}
      \UnaryInfC{$X_i \derive{\star} \gamma_i\text{ за }i \leq n$}
      \UnaryInfC{$X_0 \cdots X_{n} \derive{\star} \gamma_0\cdots\gamma_{n}$}
