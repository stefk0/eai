...
\begin{framed}
  \begin{prop}
    ...
    $\alpha_i \stackrel{n_i}{\to} \beta_i$, където $\beta = \beta_1\cdots \beta_k$ и $n = \sum^k_{i = 1}n_i$.
  \end{prop}
\end{framed}
\begin{proof}
  Индукция по $n$.
