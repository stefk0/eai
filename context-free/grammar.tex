...
Като частен случай на \Proposition{unrestricted-grammar:context-general-step} получаваме следното свойство.
...
\begin{example}
  ...
  \begin{prooftree}
    ...
    \RightLabel{\scriptsize{(\Proposition{context-free-grammar:context-general-step})}}
  ...
  \begin{prooftree}
    ...
    % \AxiomC{}
    % \RightLabel{\scriptsize{(0)}}
    % \UnaryInfC{$aabb \derive{0}_G aabb$}
    % \RightLabel{\scriptsize{(1)}}
