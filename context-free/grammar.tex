...
\begin{prop}
  ...
  Ако $\alpha \stackrel{n}{\to} \beta$ и $\gamma \in (V \cup \Sigma)^\star$, то $\alpha\gamma \stackrel{n}{\to} \beta \gamma$ и $\gamma\alpha \stackrel{n}{\to} \gamma \beta$.
\end{prop}

\begin{prop}
  \label{pr:grammar:concat}
  Ако $\alpha_1 \stackrel{n_1}{\to} \beta_1, \dots, \alpha_k \stackrel{n_k}{\to} \beta_k$, тогава $\alpha_1\cdots\alpha_k \stackrel{n}{\to} \beta_1\cdots\beta_k$,
  където $n = \sum^k_{i=1} n_i$.
\end{prop}

\begin{prop}
  \label{pr:grammar:divide}
  Нека $\alpha_1\cdots \alpha_k \stackrel{n}{\to} \beta$.
  Тогава съществуват $\beta_1,\dots,\beta_k$, такива че $\alpha_i \stackrel{n_i}{\to} \beta_i$, където $\beta = \beta_1\cdots \beta_k$ и $n = n_1 + \cdots + n_k$.
\end{prop}
\begin{proof}
  Индукция по $n$.
  \begin{itemize}
  ...
  \item
    Нека $n > 0$. Тогава за някое $i$, $\alpha_i \to \alpha'_i$ и
    като приложим \Prop{grammar:add} получаваме, че
    \[\alpha_1\cdots\alpha_i\cdots\alpha_k \to \alpha_1\cdots\alpha'_i\cdots\alpha_k.\]
    Според дефиницията на релацията $\stackrel{n}{\to}$ имаме, че
    \[\alpha_1\cdots\alpha'_i\cdots\alpha_k \stackrel{n-1}{\to} \beta.\]
    От И.П. получаваме, че съществуват думи $\beta_1,\dots,\beta_k$, такива че $\beta = \beta_1 \cdots \beta_k$
    и $\alpha_j \stackrel{n_j}{\to} \beta_j$ за $j \neq i$ и $\alpha'_i \stackrel{n'_i}{\to} \beta_i$, като
    \[n-1 = n'_i + \sum_{j\neq i} n_j.\]
    Понеже имаме, че $\alpha_i \to \alpha'_i \stackrel{n'_i}{\to} \beta_i$,
    то е ясно, че за $n_i = n'_i + 1$ имаме $\alpha_i \stackrel{n_i}{\to} \beta_i$.
  \end{itemize}
\end{proof}
