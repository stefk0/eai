...
\begin{proof}
  ...
  \begin{prooftree}
    \AxiomC{$A \to_G \alpha_1\beta_1\cdots\alpha_iB_i\cdots\alpha_n B_n\alpha_{n+1}$}
  ...
  \begin{prooftree}
    \AxiomC{$A \to_G \alpha_1\beta_1\cdots\alpha_i\beta_i\cdots\alpha_n B_n\alpha_{n+1}$}
    \AxiomC{$B_n \yield{< \ell} \beta_n$}
    \RightLabel{\scriptsize{\IndHyp}}
