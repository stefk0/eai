...
\begin{hint}
  ...
  \item 
    ...
    \item
      ...
      \marginpar{Обърнете внимание, че имаме $\texttt{E[n]}^\star$, а
        не просто $\texttt{E[n]}$.}
      \marginpar{Също така да напомним, че $\emptyset^\star = \{\varepsilon\}$.}
    ...
    \item
      \marginpar{Намираме $\texttt{E}$ за време $\mathcal{O}(|G|^2)$.}
