...
\begin{example}
  ...
  \begin{align*}
    (\qstart, abbbaa, \#) & \vdash (\qstart, bbbaa, A\#) & \comment{\text{правило }(2)}\\
                          & \vdash (\qstart, bbaa, \#) & \comment{\text{правило }(6)}\\
                          & \vdash (\qstart, baa, B\#) & \comment{\text{правило }(3)}\\
                          & \vdash (\qstart, aa, BB\#) & \comment{\text{правило }(7)}\\
                          & \vdash (\qstart, a, B\#) & \comment{\text{правило }(5)}\\
