...
\begin{prooftree}
  \AxiomC{$\Delta(q,x,A) \ni (p,\beta)$}
  \UnaryInfC{$(q,x\alpha,A\gamma) \vdash_P (p,\alpha,\beta\gamma)$}
\end{prooftree}
  ...
  \item
    ...
    \item
      ...
      \begin{prooftree}
        ...
        \AxiomC{$(p,\beta,\gamma_1\sharp ) \vdash^{\ell-1}_P (p, \varepsilon, \sharp)$}
        \RightLabel{\scriptsize{\IndHyp}}
        \UnaryInfC{$\gamma_1 \lderive{\star} \beta$}
        \BinaryInfC{$\underbrace{a \gamma_1}_{\gamma} \lderive{\star} \underbrace{a\beta}_{\alpha}$}
      \end{prooftree}
      % Тогава от \IndHyp получаваме, че $\gamma_1 \lderive{\star} \beta$ и оттук
      % \[\underbrace{a \gamma_1}_{\gamma} \lderive{\star} \underbrace{a\beta}_{\alpha}.\]
    \item
      ...
      \begin{prooftree}
        \AxiomC{$A \to a$}
        \UnaryInfC{$A\gamma_1 \lderive{1} a\gamma_1$}
        \AxiomC{$(p,\alpha,a\gamma_1\sharp ) \vdash^{\ell-1}_P (p, \varepsilon, \sharp)$}
        \RightLabel{\scriptsize{\IndHyp}}
        \UnaryInfC{$a\gamma_1 \lderive{\star} \alpha$}
        % \RightLabel{\scriptsize{правило (1)}}
        \BinaryInfC{$\underbrace{A\gamma_1}_{\gamma} \lderive{\star} \alpha$}
      \end{prooftree}
    \item
      ...
      \begin{prooftree}
        \AxiomC{$A \to BC$}
        \UnaryInfC{$A\gamma_1 \lderive{1} BC\gamma_1$}
        \AxiomC{$(p,\alpha, BC\gamma_1\sharp ) \vdash^{\ell-1}_P (p, \varepsilon, \sharp)$}
        \RightLabel{\scriptsize{\IndHyp}}
        \UnaryInfC{$BC\gamma_1 \lderive{\star} \alpha$}
        % \RightLabel{\scriptsize{правило (1)}}
        \BinaryInfC{$\underbrace{A\gamma_1}_{\gamma} \lderive{\star} \alpha$}
      \end{prooftree}
    \end{itemize}
