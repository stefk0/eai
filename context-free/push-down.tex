...
\begin{proof}
  ...
  \begin{align*}
    (p, \underbrace{\alpha_1\alpha_2}^{\alpha}, S\sharp) & \vdash^\star_P (p, \alpha_2, A\gamma_2\sharp) & \comment{\text{от (\ref{eq:5})}}\\
  ...
  % \begin{itemize}
    % \item
      ...
      \begin{prooftree}
        ...
        \AxiomC{$(p,\alpha,\gamma\rho\sharp ) \vdash^{\ell-1}_P (p, \varepsilon, \sharp)$}
        \RightLabel{\scriptsize{\IndHyp}}
