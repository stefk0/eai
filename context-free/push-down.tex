...
Сега можем дефинираме бинарната релация $\vdash^\ell_P$ над $Q\times\Sigma^\star\times\Gamma^\star$, която ни казва как една конфигурация се променя след изчисление от $\ell$ стъпки на стековия автомат:
