...
\begin{example}
  ...
  \begin{align*}
    (\qstart, a^2b^2, \#) & \vdash_P (\qstart, ab^2, A\#) & (\text{правило }(1))\\
...
\begin{example}
  ...
  \begin{align*}
    (\qstart,abaaba,\#) & \vdash_P (\qstart,baaba,A\#) & (\text{правило }(1))\\
                        & \vdash_P (\qstart, aaba, BA\#) & (\text{правило }(6))\\
                        & \vdash_P (\qstart, aba, ABA\#) & (\text{правило }(5)).
  \end{align*}
  ...
  \begin{align*}
    (\qstart, aba, ABA\#) & \vdash_P (p, ba, BA\#) & (\text{правило }(4))\\
  ...
  \begin{align*}
    (\qstart,aba,\#) & \vdash_P (\qstart, ba,A\#) & (\text{правило }(1))\\
                     & \vdash_P (\qstart, a, BA\#) & (\text{правило }(6))\\
                     & \vdash_P (\qstart, \varepsilon, ABA\#) & (\text{правило }(5)).
  \end{align*}
...
\begin{example}
  ...
  \item
    ...
    \item
      $\Delta(\qstart, b, \#) = \{(\qstart, B\#)\}$;
    \item
      $\Delta(\qstart, a, A) = \{(\qstart, AA)\}$;
    \item
      $\Delta(\qstart, a, B) = \{(\qstart, \varepsilon)\}$;
    \item
      $\Delta(\qstart, b, A) = \{(\qstart, \varepsilon)\}$;
    \item
      $\Delta(\qstart, b, B) = \{(\qstart, BB)\}$.
    \end{enumerate}
  \end{itemize}
  Да видим защо думата $abbbaa \in \L_S(P)$.
  \begin{align*}
    (\qstart, abbbaa, \#) & \vdash (\qstart, bbbaa, A\#) & (\text{правило }(2))\\
    & \vdash (\qstart, bbaa, \#) & (\text{правило }(6))\\
    & \vdash (\qstart, baa, B\#) & (\text{правило }(3))\\
    & \vdash (\qstart, aa, BB\#) & (\text{правило }(7))\\
    & \vdash (\qstart, a, B\#) & (\text{правило }(5))\\
    & \vdash (\qstart, \varepsilon, \#) & (\text{правило }(5))\\
    & \vdash (\qstart, \varepsilon, \varepsilon) & (\text{правило }(1)).
  \end{align*}
\end{example}
