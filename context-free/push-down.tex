...
\marginpar{На англ. {\em Push-down automaton}. В този курс няма да разглеждаме детерминирани стекови автомати. Когато кажем стеков автомат, ще имаме предвид недетерминиран стеков автомат.
...
\begin{proof}
  ...
  \item[$(\Rightarrow)$]
    ...
    \item
      ...
      \end{align*}
      Като използваме \Proposition{grammar:concat}, получваме, че
...
\begin{hint}
  ...
  \marginpar{Сравнете с конструкцията от \Proposition{automata-cap}.}
