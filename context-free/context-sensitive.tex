...
\mynote{На англ. context-sensitive \cite[стр. 223]{hopcroft1}. На български може да се преведат и като контекстнозависими граматики. В йерархията на Чомски това са граматиките от тип 1.
  В дефиницията, позволяваме и правилото $S \to \varepsilon$, ако искаме да включим $\varepsilon$ в езика, като тогава изискваме $S$ да не се среща в дясна страна на правило. По-проста граматика в \cite[стр. 202]{shallit}.}
