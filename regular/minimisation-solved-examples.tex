...
\begin{extra2}
  \begin{example}
    ...
    \begin{figure}[H]
      ...
      \end{tikzpicture}
      \caption{\scriptsize{Ще построим минимален автомат разпознаващ езика на $\A$.}}
    \end{figure}
  ...
  \begin{figure}[H]
    ...
    \end{tikzpicture}
  \caption{\scriptsize{Минимален автомат $\M$ за езика на $\A$.}}
  \label{fig:min1}
\end{figure}
\end{example}
\end{extra2}
  ...
  \begin{figure}[H]
    \centering
      \begin{tikzpicture}[->,>=stealth,thick,node distance=55pt]
        ...
        (5) edge [loop right]    node [above] {$a,b$} (5);
      \end{tikzpicture}
      \caption{\scriptsize{Ще построим минимален автомат разпознаващ $\L(\A)$.}}
    \end{figure}
  %   \qquad
  %   \qquad
  ...
  \item
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[->,>=stealth,thick,node distance=55pt]
        ...
        (3) edge [loop above]   node [above] {$a,b$}   (3);
      \end{tikzpicture}
      \caption{\scriptsize{Получаваме минималния автомат $\M$, $\L(\M) = \L(\A)$.}}
      \label{fig:min2}
    \end{figure}
  \end{example}
\end{extra2}
