...
\begin{example}
  ...
  \marginpar{\writedown Съобразете сами, че $\L(\A) = \{\alpha \in \{a,b\}^\star \mid \abs{\alpha} \geq 2\}$.}
  \begin{framed}
    \begin{figure}[H]
...
\end{example}
  ...
  {\scriptsize
  \begin{hint}
    \marginpar{\writedown Съобразете сами, че $\L(\A) = \{a,b\} \cup \{\alpha \in \{a,b\}^\star \mid \abs{\alpha} \geq 3\}$.}
