...
\begin{problem}
  ...
  \marginpar{\writedown Съобразете, че $\L(\A) = \{\omega \in \{a,b\}^\star \mid \abs{\omega} \geq 2\}$.}
  \begin{framed}
    \begin{figure}[H]
...
\ExtraMaterial{
  \begin{solution}
    \marginpar{\writedown Съобразете, че $\L(\A) = \{\omega \in \{a,b\}^\star \mid \abs{\omega} = 1 \lor \abs{\omega} \geq 3\}$.}
