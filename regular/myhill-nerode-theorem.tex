...
\begin{proof}
  ...
  \marginpar{Функцията на преходите $\delta$ е дефинирана чрез произволен представител на всеки клас на еквивалентност относно $\approx_L$. Трябва да съобразим,
