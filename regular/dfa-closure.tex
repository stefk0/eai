...
\end{framed}
\begin{hint}
  \marginpar{\ding{45} Докажете, че така построения автомат $\A$ разпознава $L_1\cup L_2$. Тук отново е важно, че $\delta_1$ и $\delta_2$ са тотални функции на преходите.}
