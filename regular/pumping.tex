...
\begin{proof}
  ...
  \item[$(\exists)$]
    \marginpar{Няма общо правило, което да ни казва как избираме думата $\alpha$. Трябва сами да се досетим.}
  ...
  \item[$(\exists)$]
    \marginpar{Изборът на $i$ може да зависи разбиването $x$, $y$, $z$. В конкретния пример, не зависи.}
...
\begin{remark}
  \marginpar{\writedown Съобразете сами!}
