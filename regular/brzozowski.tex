\section{Метод на Бжожовски за строене на автомат}
\index{Бжожовски}

\marginpar{Бжожовски описва алгоритъм за строене на автомат по регулярен израз в статията \cite{brzozowski-derivatives}}
