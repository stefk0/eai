...
\mynote{Тук е важно да отбележим, че все още не знаем, че $\B$ е краен. В \Example{regular:brzozowski:an-bn} ще видим един детерминиран безкраен автомат за език, който не е регулярен.}
