...
\begin{problem}
  \mynote{Тази задача е давана на държавен изпит във ФМИ през септември 2021 год.}
  Нека $L$ е регулярен език над азбуката $\Sigma$.
  Вярно ли е, че езикът $L' = \{\beta\alpha \in \Sigma^\star \mid \alpha\beta \in L\}$
  е регулярен? Обосновете отговора си като приложите доказателство!
\end{problem}
