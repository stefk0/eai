\section{Експоненциална експлозия}\label{sect:regular:nfa:exponential-blowup}
...
\begin{hint}
  ...
  \[L = \{\omega a \delta \in \{a,b\}^\star \mid |\delta| = n-1\}.\]
  ...
  \item
    \mynote{Съобразете, че тук $\abs{\omega} = i$ и $\abs{\delta} = n - i - 1$. Не е важно как разширяваме $\alpha$ и $\beta$ за да получим $\alpha_0$ и $\beta_0$. Тук за да бъдем конкретни сме избрали просто $a^i$. Важното е това разширение да има дължина $i$.}
