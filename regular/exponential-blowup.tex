...
\marginpar{Тук следваме \cite[66]{khoussainov-nerode}. В \cite[стр. 80]{shallit} има друг пример за НКА с $n$ състояния вместо $n+1$, но доказателството изглежда по-сложно.}
\begin{proposition}
