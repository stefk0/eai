...
\mynote{
  \begin{itemize}
  \item
    $\equiv^0_\A$ има точно два класа на еквивалентност.
  \item
    $\equiv^1_\A$ има не повече от три класа на еквивалентност
  \item
    $\equiv^{|Q|-2}_\A$ има не повече от $|Q|$ класа на еквивалентност. 
  \end{itemize}
}
\begin{proof}
