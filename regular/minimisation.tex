...
\begin{framed}
  \begin{prop}
    ...
    Нека $\A = \FA$ е тотален ДКА {\em без недостижими състояния от} $\qstart$.
    Тогава
...
\begin{hint}
  ...
  Тогава от \Cor{upper-bound} следва, че $\A'$ е минимален автомат.
\end{hint}
...
\begin{example}
  ...
  \begin{framed}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
      ...
      \end{tikzpicture}
      \caption{Получаваме минималния автомат $\A_0$, $\L(\A_0) = \L(\A)$}
      \label{sub:min1}
    \end{subfigure}
  \end{figure}
  \end{framed}
