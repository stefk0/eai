...
\begin{example}
  ...
  \begin{itemize}
  \item 
    $a^{-1}(L) = \{a,b\}^\star b = M$, т.е. $\delta(q_L,a) = q_M$;
  \item
    $b^{-1}(L) = \emptyset$, т.е. $\delta(q_L,b) = q_\emptyset$;
  \item
    $a^{-1}(M) = \{b\} \cup \{a,b\}^\star b = N$, т.е. $\delta(q_M,a) = q_N$;
  \item
    $b^{-1}(M) = \{\varepsilon\} \cup \{b\} \cup \{a,b\}^\star b = P$, т.е. $\delta(q_M,b) = q_P$;
  \item
    $a^{-1}(N) = \{b\} \cup \{a,b\}^\star b = M$, т.е. $\delta(q_N,b) = q_M$;
  \item
  ...
  \item
    Ясно е, че $a^{-1}(\emptyset) = b^{-1}(\emptyset) = \emptyset$.
  \end{itemize}

  Единственото финално състояние е $q_P$, защото $\varepsilon$ е елемент единствено на $P$.
