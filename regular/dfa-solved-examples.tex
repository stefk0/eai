...
\mynote{Винаги с удвоени окръжности ще отбелязваме финалните състояния. За момента не е ясно как можем да докажем, че даденият автомат разпознава точно съответния език.}
