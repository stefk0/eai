...
\begin{proof}
  ...
  \marginpar{$\abs{\alpha} \df $ дължината на думата $\alpha$.}
...
\marginpar{Да отбележим, че за всяко число $n$ има безкрайно много думи $\alpha$, за които $\bin{\alpha} = n$. Например, $\bin{10} = \bin{010} = \bin{0010} = \cdots$}
