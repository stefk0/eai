...
\begin{definition}
  \marginpar{Въведени от Рабин и Скот \cite{rabin-scott}. За по-голяма яснота, често ще означаваме с $\N$ недетерминирани автомати, като ще запазим $\A$ за детерминираните.}
  \index{Рабин}
  \index{Скот}
