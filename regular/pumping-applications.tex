...
\begin{corollary}\label{cor:pumping-applications:equal-languages}
  \mynote{За \Corollary{pumping-applications:equal-languages}, съобразете, че $L_1 = L_2$ точно тогава, когато $(L_1\setminus L_2) \cup (L_2 \setminus L_1) = \emptyset$.}
