...
\begin{framed}
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
    \end{center}
    \caption{\footnotesize{Непълно описание на двулентова детерминистична машина на Тюринг $\M$, за която $\L(\M) = \{\omega\sharp\omega \mid \omega \in \{a,b\}^\star\}$. Всички неописани преходи трябва да сочат към отхвърлящото състояние $q_5$.}}
  \end{figure}
\end{framed}
