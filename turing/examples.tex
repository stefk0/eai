...
\begin{extra}
\begin{example}
  \mynote{Знаем, че $L$ не е безконтекстен, но е контекстен.}
  ...
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
    \end{center}
    \caption{\footnotesize{Част от детерминистична машина на Тюринг $\M$, за която разрешава езика $\{a^nb^nc^n \mid n \in \Nat\}$. Остава да се добави $\qreject$ и да се попълни $\delta$ функцията до тотална.}}
  \end{figure}
  \end{framed}
...
\begin{framed}
  \begin{figure}[H]
    \begin{center}
      ...
      \end{tikzpicture}
    \end{center}
    \caption{\footnotesize{Детерминистична машина на Тюринг $\M$, която \emph{разрешава} езика $\{a^nb^nc^n \mid n \in \Nat\}$. Отхвърлящото състояние е $q_6$, т.е. $\qreject \df q_6$.}}
  \end{figure}
\end{framed}
\end{example}
  ...
  \begin{framed}
    \begin{figure}[H]
      \begin{center}
        ...
        \end{tikzpicture}
      \end{center}
      \caption{\footnotesize{Част от машина на Тюринг $\M$, която разрешава езика $\{\omega\sharp\omega \mid \omega \in \{a,b\}^\star\}$.}}
    \end{figure}
  \end{framed}
