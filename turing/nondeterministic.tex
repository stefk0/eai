...
\begin{figure}[H]
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      ...
      \UnaryInfC{$(\alpha, q, xz\beta) \vdash_\N (\alpha y, p, z\beta)$}
    \end{prooftree}
    \vspace*{2mm}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      ...
      \UnaryInfC{$(\alpha z, q, x\beta) \vdash_\N (\alpha,p,zy\beta)$}
    \end{prooftree}
    \vspace*{2mm}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      ...
      \UnaryInfC{$(\alpha, q, x) \vdash_\N (\alpha y, p, \blank)$}
    \end{prooftree}
    \vspace*{2mm}
  \end{subfigure}
  ~
  \begin{subfigure}[b]{0.5\textwidth}
    \begin{prooftree}
      ...
      \UnaryInfC{$(\varepsilon,q,x\beta) \vdash_\N (\varepsilon,p,\blank y\beta)$}
    \end{prooftree}
    \vspace*{2mm}
  \end{subfigure}
  ...
  \begin{prooftree}
    ...
    \UnaryInfC{$(\alpha, q, z\beta) \vdash_\N (\alpha , p, y\beta)$}
  \end{prooftree}
  \caption{Едностъпков преход в недетерминистична машина на Тюринг}
\end{figure}
\end{important}
