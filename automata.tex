  ...
  \begin{figure}[H]
    ...
    \begin{subtable}[b]{0.4\textwidth}
        \begin{tabular}{|c|c|c|c|c|c|c|}
          ...
          \hline
          \hline
          $\equiv_0$ & $A^0_0$ & $A^0_0$ & $A^0_0$ & $A^1_0$ & $A^1_0$ & $A^1_0$\\
          \hline
          $a$ & $A^0_0$& $A^1_0$ & $A^1_0$ & $A^1_0$ & $A^1_0$ & $A^1_0$\\
          \hline
          $b$ & $A^0_0$& $A^1_0$ & $A^1_0$ & $A^1_0$ & $A^1_0$ & $A^1_0$\\
          \hline
          \hline
          $\equiv_1$ & $A^0_1$ & $A^1_1$ & $A^1_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$\\
          \hline
          $a$ & $A^1_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$\\
          \hline
          $b$ & $A^1_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$ & $A^2_1$\\
          \hline
        \end{tabular}        
        \caption{Класовете на еквивалентност относно релацията $\equiv_n$. Получаваме, че $\equiv_1\ =\ \equiv_2$}
      \end{subtable}
      \begin{subfigure}[H]{0.5\textwidth}
        \begin{tikzpicture}[->,>=stealth,thick,node distance=45pt]
          \tikzstyle{every state}=[circle,minimum size=20pt,auto]
          
          \node[initial, state]   (0) {$A^0_1$};
...
\begin{example}
  ...
  Получаваме следния минимален автомат $\A_0$ разпознаващ езика $\L(\A)$.
