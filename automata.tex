...
\begin{proof}
  ...
  \item
    Избираме дума $\alpha \in L$, за която $\abs{\alpha} \geq p$. Имаме свободата да изберем каквото $\alpha$
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
      \begin{tikzpicture}[->,>=stealth,thick,node distance=45pt]
        ...
        \node[initial above, state]   (0) {$Q^0_1$};
        \node[state]            (1) [right of=0]{$Q^1_1$};
        \node[state,accepting]  (2) [right of=1]{$Q^2_1$};
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
      \begin{tikzpicture}[->,>=stealth,thick,node distance=45pt]
        ...
        \node[initial above, state]   (0) {$Q^0_2$};
        \node[state,accepting]  (1) [right of=0]{$Q^1_2$};
        \node[state]            (2) [right of=1]{$Q^2_2$};
        \node[state,accepting]  (3) [right of=2]{$Q^3_2$};
