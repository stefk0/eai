...
\begin{problem}
  За всеки НКА $\A$ съществува НКА $\A'$ с едно финално състояние, 
  за който $\L(\A) = \L(\A')$.
\end{problem}
\begin{hint}
...
Обърнете внимание, че $\N$ е детерминиран, но $\N'$ е недетерминиран.
\end{hint}
...
\end{problem}
\begin{hint}
  Нека $\A$ е НКА с едно финално състояние.
