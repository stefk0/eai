...
\begin{example}
  ...
  Да видим как можем директно да построим минимален тотален детерминиран автомат $\A = \FA$ разпознаващ $L$.
  ...
  \item 
    ...
    Следователно, имаме ново състояние $q_M$ в автомата и 
    $\delta_\A(q_L,a) = q_M$.
  \item
    $b^{-1}L = aL\cup (a+b)^+aL = M$;
    Следователно, $\delta_\A(q_L,b) = q_M$.
  \item
    $a^{-1}M = L \cup aL \cup (a+b)^+aL \df N$;
    Следователно, имаме ново състояние $q_N$ в автомата и 
    $\delta_\A(q_M,a) = q_N$.
  \item
    $b^{-1}M = aL\cup (a+b)^+aL = M$;
    Следователно, $\delta_\A(q_M,b) = q_M$.
  \item
    $a^{-1}N = a^{-1}L \cup L \cup aL \cup (a+b)^+aL = N$;
    Следователно, $\delta_\A(q_N,a) = q_N$.
  \item
  ...
  Понеже имаме, че 
  \[B = \{\omega \in \Sigma^\star \mid \delta^\star(q_B,\omega) \in F\},\]
  ...
  \begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption{Минимален автомат за рег. израз $((a+b)^+a)^\star$}
  \end{figure}
  ...
  \item
    Понеже $\delta_\A(q_L,a) = q_M$, то $f(q_M) = f(q_L)\cdot[a]_L = [a]_L$. Ясно е, че $[\varepsilon]_L \neq [a]_L$.
  \item
    Понеже $\delta_\A(q_L,b) = q_M$, то $f(q_M) = f(q_L)\cdot[b]_L$. Лесно се вижда, че наистина $[a]_L = [b]_L$.
  \item
    Понеже $\delta_\A(q_M,a) = q_N$, то $f(q_N) = f(q_M)\cdot[a]_L = [aa]_L$. Лесно се вижда, че $[aa]_L \neq [\varepsilon]_L$
    и $[aa]_L \neq [a]_L$.
  \item
    Понеже $\delta_\A(q_M,b) = q_M$, то $f(q_M) = f(q_N)\cdot[b]_L = [ab]_L$. Лесно се вижда, че $[a]_L = [aab]_L$.
  \item
    Понеже $\delta_\A(q_N,a) = q_N$, то $f(q_N) = f(q_N)\cdot[a]_L = [aaa]_L$. Лесно се вижда, че $[aa]_L = [aaa]_L$.
  \item
    Понеже $\delta_\A(q_N,b) = q_M$, то $f(q_M) = f(q_N)\cdot[b]_L = [aab]_L$. 
  \end{itemize}
...
\begin{example}
  ...
  \item
    $b^{-1}L = \emptyset$;
  \item
    $a^{-1}M = b + (a+b)^\star b = N$;
  \item
    $b^{-1}M = \varepsilon + b + (a+b)^\star b = P$;
  \item
    $a^{-1}N = b \cup (a+b)^\star b = M$;
  \item
    $b^{-1}N = \varepsilon \cup b \cup (a+b)^\star b = P$;
  \item
    $a^{-1}P = b + (a+b)^\star b = N$;
  \item
    $b^{-1}P = \varepsilon + b + (a+b)^\star b = P$.
  \end{itemize}
...
\section{Граматики. Регулярни граматики}
\index{граматика!неограничена}

{\bf Граматика} e четворка от вида
\[G = (V, \Sigma, R, S),\]
където
\begin{itemize}
\item
...
\item
  ...
  Обикновено правилата $(\alpha, \beta) \in R$ се означават $\alpha \to \beta$, където $\alpha, \beta \in (V \cup \Sigma)^\star$;
\item
...
Граматиките се разделят на няколко вида в зависимост от това какви ограничения налагаме върху правилата $R$.
