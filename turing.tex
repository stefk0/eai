...
\begin{example}
  ...
  \begin{align*}
    _1ab\sharp ab & \to x_2b\sharp ab \to xb_2\sharp ab \to xb\sharp _4ab \to xb_6\sharp xb \to x_7b\sharp xb \to _7xb\sharp xb \to x_1b\sharp xb\\
...
\begin{proof}
  ...
  Символите $X$ ще маркират къде се намира главата на всяка лента като позволяваме да имаме само по една клетка $X$ за 
\end{proof}
