...
% Понякога за по-кратко ще записваме конфигурацията във вида $\alpha_q\beta$.

{\em Началната конфигурация} за входа $\alpha \in \Sigma^\star$ представлява 
\[(\varepsilon, s, \alpha).\]
...
\begin{example}
  ...
  \marginpar{В \cite[стр. 155]{hopcroft1} е даден по-различно решение. Тук следваме \cite[стр. 173]{sipser3}. Там има малка грешка}
  ...
  \begin{align*}
    _1abcab & \to x_2bcab \to xb_2cab \to xbc_4ab \to xb_6cxb \to x_7bcxb \to _7xbcxb \to x_1bcxb\\
    & \to xx_3cxb \to xxc_5xb \to xxcx_5b \to xxc_6xx \to xx_6cxx \to x_7xcxx \to xx_1cxx \\
    & \to xxc_8xx \to xxcx_8x \to xxcxx_8\blank \to xxcxx\blank_9\blank
  \end{align*}
...
\end{prop}
\begin{proof}
  \marginpar{\cite[стр. 162]{hopcroft1}}
  ...
  $\Gamma' = (\{\blank, X\} \times \Gamma)^k$, където $X$ е нов символ.
  Символите $X$ ще маркират къде се намира главата на всяка лента.
  
  като позволяваме да имаме само по една клетка $X$ за 
\end{proof}

\subsection*{Недетерминистични машини на Тюринг}

Една машина на Тюринг се нарича недетерминистична, ако функцията на преходите има вида
\[\Delta: Q\times \Gamma \to \Ps(Q \times \Gamma\times \{L,R\}). \]
