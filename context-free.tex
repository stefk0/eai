...
\begin{lemma}[за нарастването (безконтекстни езици)]
  \index{лема за нарастването!безконтекстни езици}
...
Тройките от вида $(q,\alpha,\gamma) \in Q\times\Sigma^\star\times\Gamma^\star$ описват моментното описание
на стековия автомат, т.е. автоматът се намира в състояние $q$, думата, която остава да се прочете е $\alpha$,
...
Важно е да отбележим, че е възможно $x = \varepsilon$.
...
\begin{example}
  ...
  \end{align*}
  От последното моментно състояние на автомата нямаме нито един преход, следователно
