...
\begin{problem}
  ...
  \begin{enumerate}[a)]
  \item
    $S \to \varepsilon\ |\ ab\ |\ aAba,\ A\to aBCb,\ B\to bbb, C\to aC\ |\ aCaC$;
  \item
    $S \to \varepsilon\ |\ ab\ |\ baAb, A\to BaBb,\ B\to b,\ C\to AbA\ |\ aCCa$;
  \item
    $A\to BSB\ |\ a,\ B\to ba\ |\ BC,\ C\to BaSA\ |\ a\ |\ b,\ S\to CC\ |\ b$;
  \item
    $A\to BAS,\ B\to CB,\ C\to ab\ |\ ABbS,\ S\to CC\ |\ b$;
  \end{enumerate}
\end{problem}
...
\begin{thm}
  Всеки безконтекстен език $L$ е генериран от безконтекстна граматика в нормална форма на Чомски.
\end{thm}
\begin{proof}
