...
\begin{problem}
  ...
  \begin{enumerate}[a)]
  \item 
    $L_1 = \{\omega_1a\omega_2 \mid \omega_1,\omega_2 \in \{b,c\}^\star\ \&\ \abs{\omega_1} = \abs{\omega_2}\}$;
  \item
    $L_2 = \{\omega_1a\omega_2a\cdots a\omega_n \mid n\geq 2\ \&\ \omega_1,\omega_2,\dots,\omega_n \in \{b,c\}^\star\ \&\ \abs{\omega_1} = \abs{\omega_2}\}$;
  \item
    $L_3 = \{\omega_1a\omega_2a\cdots a\omega_n \mid n\geq 2\ \&\ \omega_1,\dots,\omega_n \in \{b,c\}^\star\ \&\ (\exists i, j)[i \neq j\ \&\ \abs{\omega_i} = \abs{\omega_j}]\}$.
  \end{enumerate}
\end{problem}
...
\end{thm}
\begin{proof}
  \marginpar{Защо е важен реда на прилагане?}
